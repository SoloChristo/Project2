...
ggplot(city_cases, aes(x=Population, y=Confirmed_Cases)) +
  
  geom_point() +
  
  scale_x_continuous(name="Population", labels=function(x) format(x, scientific = FALSE), trans = 'log') + # y axis
  
  scale_y_continuous(name="Confirmation Counts", labels=function(x) format(x, scientific = FALSE), trans = 'log') 
