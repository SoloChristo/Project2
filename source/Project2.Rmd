...
ggplot(city_cases, aes(Population, Confirmed_Cases)) +
  
  geom_point() +
  
  scale_x_log10(name="Population", labels=function(x) format(x, scientific = FALSE)) + # y axis
  
  scale_y_log10(name="Confirmation Counts", labels=function(x) format(x, scientific = FALSE)) # y axis
